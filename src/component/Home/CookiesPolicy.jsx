    ...
    return (
        <div className='m-10'>
            ...
            <h2 className='text-2xl font-bold'>Definitions</h2>
                ...
                <ul>
                    <li><strong>Company</strong> (referred to as either &quot;the Company &quot;, &quot;We&quot;, &quot;S&quot; or &quot;Or &quot; in this Cookies Policy) refers to XOX Rides Inc., Los Angles .</li>
                    <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                    <li><strong>Website</strong> refers to XOX Rides, accessible from <a href="https://xoxrides.com/" rel="external nofollow noopener" target="_blank">https://xoxrides.com/</a></li>
                    <li><strong>You</strong> means the individual accessing or using the Website, or a company, or any legal entity on behalf of which such individual is accessing or using the Website, as applicable.</li>
                </ul>
            <h1 className='text-4xl font-bold'>The use of the Cookies</h1>
            <h2 className='text-2xl font-bold'>Type of Cookies We Use</h2>
            ...
            <h2 className='text-3xl font-bold'>Your Choices Regarding Cookies</h2>
            ...
            <h2 className='text-3xl font-bold'>More Information about Cookies</h2>
            ...
            <h2 className='text-3xl font-bold'>Contact Us</h2>
                ...
                <ul>
                    <li>
                        <p>By email: hello@xoxrides.com</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="https://xoxrides.com/contact" rel="external nofollow noopener" target="_blank">https://xoxrides.com/contact</a></p>
                    </li>
                </ul>
